...
class DresscodeDataset(BaseDataset):
    ...
    def get_sample(self, idx):
        ...
        tar_image_path = tar_mask_path.replace("label_maps/", "images/").replace(
            "_4.png", "_0.jpg"
        )
        ref_image_path = tar_mask_path.replace("label_maps/", "images/").replace(
            "_4.png", "_1.jpg"
        )
        ...
        item_with_collage = self.process_pairs(
            ref_image, ref_mask, tar_image, tar_mask, max_ratio=1.0
        )
